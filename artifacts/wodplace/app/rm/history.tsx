    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.ctaRow}>
          <Pressable
            onPress={() => router.push('/rm/record' as never)}
            style={({ pressed }) => [
              styles.cta,
          ...
          <View style={{ gap: 10 }}>
            {rows.map((r) => {
              ...
              return (
                <Pressable
                  key={r.movementId}
                  onPress={() => router.push(`/rm/movement/${r.movementId}` as never)}
                  style={({ pressed }) => [
                    styles.card,
                ...
                >
                  <View style={{ flex: 1, gap: 3 }}>
                    <Text style={[styles.cardTitle, { color: colors.foreground }]}>{r.liftName}</Text>
                  ...
                  <View style={styles.cardRight}>
                    <Text style={[styles.cardRm, { color: colors.foreground }]}>{trimNum(best, 1)}</Text>
