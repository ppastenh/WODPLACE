...
/**
 * TEMPORARY "Más" screen. Holds the admin tools that don't exist in the full
 * box-admin dashboard yet: box name, contract acceptances, moderation
 * reports. Reached from the profile menu (admin-gated). To be folded into the
 * dashboard / reorganised later — kept deliberately plain for now.
 */
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <KeyboardAwareScrollViewCompat contentContainerStyle={styles.scrollContent}>
        ...
        <Text style={[styles.subtitle, { color: colors.mutedForeground }]}>
          Herramientas de administración que todavía no están en el panel
          completo.
        </Text>
